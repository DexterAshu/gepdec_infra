...
@Component({
  selector: 'app-tech-qualification',
  templateUrl: './tech-qualification.component.html',
  styleUrls: ['./tech-qualification.component.css']
})
export class TechQualificationComponent {
