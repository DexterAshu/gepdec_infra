...
@Component({
  selector: 'app-indirect-biding',
  templateUrl: './indirect-biding.component.html',
  styleUrls: ['./indirect-biding.component.css']
})
export class IndirectBidingComponent {
  form!: FormGroup;   
  p: number = 1;
